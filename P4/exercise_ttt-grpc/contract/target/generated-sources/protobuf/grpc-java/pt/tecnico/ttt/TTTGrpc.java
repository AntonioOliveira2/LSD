...
public final class TTTGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pt.tecnico.ttt.RedoRequest,
      pt.tecnico.ttt.RedoResponse> getRefazerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Refazer",
      requestType = pt.tecnico.ttt.RedoRequest.class,
      responseType = pt.tecnico.ttt.RedoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.tecnico.ttt.RedoRequest,
      pt.tecnico.ttt.RedoResponse> getRefazerMethod() {
    io.grpc.MethodDescriptor<pt.tecnico.ttt.RedoRequest, pt.tecnico.ttt.RedoResponse> getRefazerMethod;
    if ((getRefazerMethod = TTTGrpc.getRefazerMethod) == null) {
      synchronized (TTTGrpc.class) {
        if ((getRefazerMethod = TTTGrpc.getRefazerMethod) == null) {
          TTTGrpc.getRefazerMethod = getRefazerMethod =
              io.grpc.MethodDescriptor.<pt.tecnico.ttt.RedoRequest, pt.tecnico.ttt.RedoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Refazer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.RedoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.ttt.RedoResponse.getDefaultInstance()))
              .setSchemaDescriptor(new TTTMethodDescriptorSupplier("Refazer"))
              .build();
        }
      }
    }
    return getRefazerMethod;
  }
  ...
  public static abstract class TTTImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void refazer(pt.tecnico.ttt.RedoRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.RedoResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRefazerMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pt.tecnico.ttt.RedoRequest,
                pt.tecnico.ttt.RedoResponse>(
                  this, METHODID_REFAZER)))
          .build();
    }
  }
  ...
  public static final class TTTStub extends io.grpc.stub.AbstractAsyncStub<TTTStub> {
    ...
    public void refazer(pt.tecnico.ttt.RedoRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.ttt.RedoResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getRefazerMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class TTTBlockingStub extends io.grpc.stub.AbstractBlockingStub<TTTBlockingStub> {
    ...
    /**
     */
    public pt.tecnico.ttt.RedoResponse refazer(pt.tecnico.ttt.RedoRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getRefazerMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class TTTFutureStub extends io.grpc.stub.AbstractFutureStub<TTTFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.tecnico.ttt.RedoResponse> refazer(
        pt.tecnico.ttt.RedoRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getRefazerMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_REFAZER = 3;
      ...
      switch (methodId) {
        ...
        case METHODID_CHECK_WINNER:
          serviceImpl.checkWinner((pt.tecnico.ttt.CheckWinnerRequest) request,
              (io.grpc.stub.StreamObserver<pt.tecnico.ttt.CheckWinnerResponse>) responseObserver);
          break;
        case METHODID_REFAZER:
          serviceImpl.refazer((pt.tecnico.ttt.RedoRequest) request,
              (io.grpc.stub.StreamObserver<pt.tecnico.ttt.RedoResponse>) responseObserver);
          break;
        default:
